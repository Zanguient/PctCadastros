object FrmRel_Folha_Pagamento: TFrmRel_Folha_Pagamento
  ...
  Caption = 'Consulta de Folhas de Pagamento'
  ClientHeight = 432
  ClientWidth = 849
  Color = clWindow
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableViewEstoque: TcxGridDBTableView
      ...
      Navigator.Buttons.GotoBookmark.Visible = False
      Navigator.Buttons.Filter.Visible = False
      DataController.DataSource = dsFolha
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Kind = skSum
    ...
    object cxGrid1DBTableView5: TcxGridDBTableView
      ...
      DataController.Summary.DefaultGroupSummaryItems = <
        item
          Format = 'R$ #0.0,0'
          Kind = skSum
          Column = cxGrid1DBTableView5Total_Credito
        end
        item
          Format = 'R$ #0.0,0'
          Kind = skSum
          Column = cxGrid1DBTableView5Total_Debito
        end
        item
          Format = 'R$ #0.0,0'
          Kind = skSum
          Column = cxGrid1DBTableView5Salario_Final
        end>
      DataController.Summary.FooterSummaryItems = <
        item
          Format = 'R$ #0.0,0'
      ...
      object cxGrid1DBTableView5Funcionario: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Mes_Ano: TcxGridDBColumn
        Caption = 'M'#234's/Ano'
      ...
      object cxGrid1DBTableView5Total_Credito: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Total_Debito: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Salario_Final: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Observacao: TcxGridDBColumn
        Caption = 'Observa'#231#245'es'
        DataBinding.FieldName = 'Observacao'
        Options.Editing = False
        Styles.Header = DM.cxStyle1
    ...
    object cxGrid1DBTableView14: TcxGridDBTableView
      ...
      Navigator.Buttons.GotoBookmark.Visible = False
      Navigator.Buttons.Filter.Visible = False
      DataController.DataSource = dsFolhaItens
      DataController.DetailKeyFieldNames = 'Codigo_Folha_Pagamento'
      DataController.KeyFieldNames = 'Codigo'
      DataController.MasterKeyFieldNames = 'Codigo'
      ...
      OptionsView.Indicator = True
      Preview.Visible = True
      object cxGrid1DBTableView14Codigo: TcxGridDBColumn
        Caption = 'C'#243'digo'
        DataBinding.FieldName = 'Codigo'
        Options.Editing = False
        Styles.Header = DM.cxStyle1
      ...
      object cxGrid1DBTableView14Item: TcxGridDBColumn
  ...
  object qryFolha: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select FP.*, CS.Descricao as Safra, CPesFun.Nome as Funcionario,' +
        ' CPag.Descricao as CondPag, '
      ...
      'left join Cadastro_Safra CS on (FP.Codigo_Safra = CS.Codigo)'
        ...
        'left join Cadastro_Pessoa CPesFun on (FP.Codigo_Funcionario = CP' +
        'esFun.Codigo)'
      
        'left join Condicao_Pagamento CPag on (FP.Codigo_Forma_Pagamento ' +
        '= CPag.Codigo)'
      
        'left join Cadastro_Plano_Financeiro CPlan on (FP.Codigo_Plano_Fi' +
        'nanceiro = CPlan.Codigo)'
      
        'left join Cadastro_Tipo_Documento CTD on (FP.Codigo_Tipo_Documen' +
        'to = CTD.Codigo)'
      
        'left join Cadastro_Departamento CD on (FP.Codigo_Departamento = ' +
        'CD.Codigo)')
    Left = 768
    Top = 104
    object qryFolhaCodigo: TIntegerField
      FieldName = 'Codigo'
    end
    object qryFolhaCodigo_Propriedade: TIntegerField
      FieldName = 'Codigo_Propriedade'
    end
    object qryFolhaCodigo_Usuario: TIntegerField
      FieldName = 'Codigo_Usuario'
    end
    object qryFolhaCodigo_Safra: TIntegerField
      FieldName = 'Codigo_Safra'
    end
    object qryFolhaCodigo_Funcionario: TIntegerField
      FieldName = 'Codigo_Funcionario'
    end
    object qryFolhaCodigo_Forma_Pagamento: TIntegerField
      FieldName = 'Codigo_Forma_Pagamento'
    end
    object qryFolhaCodigo_Plano_Financeiro: TIntegerField
      FieldName = 'Codigo_Plano_Financeiro'
    end
    object qryFolhaCodigo_Departamento: TIntegerField
      FieldName = 'Codigo_Departamento'
    end
    object qryFolhaCodigo_Tipo_Documento: TIntegerField
      FieldName = 'Codigo_Tipo_Documento'
    end
    object qryFolhaData_Lancamento: TDateTimeField
      FieldName = 'Data_Lancamento'
    end
    object qryFolhaMes_Ano: TStringField
      FieldName = 'Mes_Ano'
    end
    object qryFolhaTotal_Credito: TFloatField
      FieldName = 'Total_Credito'
    end
    object qryFolhaTotal_Debito: TFloatField
      FieldName = 'Total_Debito'
    end
    object qryFolhaSalario_Final: TFloatField
      FieldName = 'Salario_Final'
    end
    object qryFolhaCodigo_Lancamento_Financeiro: TIntegerField
      FieldName = 'Codigo_Lancamento_Financeiro'
    end
    object qryFolhaObservacao: TStringField
      FieldName = 'Observacao'
      Size = 800
    end
    object qryFolhaSafra: TStringField
      FieldName = 'Safra'
      Size = 50
    end
    object qryFolhaFuncionario: TStringField
      FieldName = 'Funcionario'
      Size = 100
    end
    object qryFolhaCondPag: TStringField
      FieldName = 'CondPag'
      Size = 50
    end
    object qryFolhaPlanoFinanceiro: TStringField
      FieldName = 'PlanoFinanceiro'
      Size = 300
    end
    object qryFolhaTipoDocumento: TStringField
      FieldName = 'TipoDocumento'
      Size = 50
    end
    object qryFolhaDepartamento: TStringField
  ...
  object qryFolhaItens: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select FPI.*, CIFP.Descricao as Item from Folha_Pagamento_Itens ' +
        'FPI'
      
        'left join Cadastro_Item_Folha_Pagamento CIFP on (FPI.Codigo_Item' +
        ' = CIFP.Codigo)')
    Left = 768
    Top = 152
    object qryFolhaItensCodigo: TAutoIncField
      FieldName = 'Codigo'
      ReadOnly = True
    end
    object qryFolhaItensCodigo_Folha_Pagamento: TIntegerField
      FieldName = 'Codigo_Folha_Pagamento'
    end
    object qryFolhaItensCodigo_Item: TIntegerField
      FieldName = 'Codigo_Item'
    end
    object qryFolhaItensValor: TFloatField
      FieldName = 'Valor'
    end
    object qryFolhaItensItem: TStringField
      FieldName = 'Item'
      Size = 50
    end
  end
  object dsFolhaItens: TDataSource
    DataSet = qryFolhaItens
    Left = 800
    Top = 152
  end
  object cxPropertiesStore1: TcxPropertiesStore
    Components = <
      item
        Component = cxGrid1DBTableView14Codigo
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView14Item
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Funcionario
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Mes_Ano
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Observacao
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Salario_Final
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Total_Credito
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Total_Debito
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
