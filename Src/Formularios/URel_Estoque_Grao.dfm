object FrmRel_Estoque_Grao: TFrmRel_Estoque_Grao
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Estoque de gr'#227'os'
  ClientHeight = 432
  ClientWidth = 849
  Color = clWindow
  ...
  object qryEstoque: TADOQuery
    ...
    Left = 592
    Top = 8
    object qryEstoqueCodigo: TAutoIncField
      FieldName = 'Codigo'
      ReadOnly = True
    end
    object qryEstoqueCodigo_Safra: TIntegerField
      FieldName = 'Codigo_Safra'
    end
    object qryEstoqueSafra: TStringField
      FieldKind = fkLookup
      FieldName = 'Safra'
      LookupDataSet = DM.qrySafra
      LookupKeyFields = 'Codigo'
      LookupResultField = 'Descricao'
      KeyFields = 'Codigo_Safra'
      LookupCache = True
      Size = 50
      Lookup = True
    end
    object qryEstoqueArmazem: TStringField
      FieldKind = fkLookup
      FieldName = 'Armazem'
    ...
    object qryEstoqueCodigo_Armazem: TIntegerField
      FieldName = 'Codigo_Armazem'
    end
    object qryEstoqueCodigo_Produto: TIntegerField
      FieldName = 'Codigo_Produto'
    end
    object qryEstoqueCodigo_Fazenda: TIntegerField
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 43024.454054467590000000
