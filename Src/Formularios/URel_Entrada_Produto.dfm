object FrmRel_Entrada_Produto: TFrmRel_Entrada_Produto
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Consulta de entradas de produtos'
  ClientHeight = 432
  ClientWidth = 849
  Color = clWindow
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView5: TcxGridDBTableView
      ...
      object cxGrid1DBTableView5N_Nota_Fiscal: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Fornecedor: TcxGridDBColumn
        DataBinding.FieldName = 'Fornecedor'
        Options.Editing = False
        Styles.Header = DM.cxStyle1
        Width = 250
      end
      object cxGrid1DBTableView5Comprador: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Data_Emissao: TcxGridDBColumn
        Caption = 'Emiss'#227'o'
      ...
      object cxGrid1DBTableView5Valor_Produtos: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Valor_Frete: TcxGridDBColumn
        Caption = 'Valor Frete'
      ...
      object cxGrid1DBTableView5Valor_Seguro: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Valor_Outras_Despesas: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Valor_Desconto: TcxGridDBColumn
      ...
      object cxGrid1DBTableView5Valor_Total_NF: TcxGridDBColumn
    ...
    object cxGrid1DBTableView14: TcxGridDBTableView
      ...
      DataController.DetailKeyFieldNames = 'Codigo_Entrada'
      DataController.KeyFieldNames = 'Codigo'
      DataController.MasterKeyFieldNames = 'Codigo'
      ...
      OptionsView.Indicator = True
      Preview.Visible = True
      object cxGrid1DBTableView14Produto: TcxGridDBColumn
        DataBinding.FieldName = 'Produto'
        Options.Editing = False
        Styles.Header = DM.cxStyle1
        Width = 200
      end
      object cxGrid1DBTableView14Valor_Compra: TcxGridDBColumn
      ...
      object cxGrid1DBTableView14Quantidade: TcxGridDBColumn
        DataBinding.FieldName = 'Quantidade'
      ...
      object cxGrid1DBTableView14Unidade: TcxGridDBColumn
        Caption = 'Un.'
        DataBinding.FieldName = 'Unidade'
        Options.Editing = False
        Styles.Header = DM.cxStyle1
      ...
      object cxGrid1DBTableView14Valor_Total: TcxGridDBColumn
        Caption = 'Valor Total'
  ...
  object qryEntrada: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select EP.*, CPesForn.Nome as Fornecedor, CPesComp.Nome as Compr' +
        'ador, CPag.Descricao as CondPag, '
      
        'CPlan.Descricao as PlanoFinanceiro, CS.Descricao as Safra, CTD.D' +
        'escricao as TipoDocumento,'
      'CD.Descricao as Departamento from Entrada_Produto EP'
      
        'left join Cadastro_Pessoa CPesForn on (EP.Codigo_Fornecedor = CP' +
        'esForn.Codigo)'
      
        'left join Cadastro_Pessoa CPesComp on (EP.Codigo_Comprador = CPe' +
        'sComp.Codigo)'
      'left join Cadastro_Safra CS on (EP.Codigo_Safra = CS.Codigo)'
      
        'left join Cadastro_Plano_Financeiro CPlan on (EP.Codigo_Plano_Fi' +
        'nanceiro = CPlan.Codigo)'
      
        'left join Condicao_Pagamento CPag on (EP.Codigo_Forma_Pagamento ' +
        '= CPag.Codigo)'
      
        'left join Cadastro_Tipo_Documento CTD on (EP.Codigo_Tipo_Documen' +
        'to = CTD.Codigo)'
      
        'left join Cadastro_Departamento CD on (EP.Codigo_Departamento = ' +
        'CD.Codigo)'
      '')
    Left = 768
    Top = 104
    ...
    object qryEntradaData_Cadastro: TDateTimeField
      FieldName = 'Data_Cadastro'
    end
    object qryEntradaCodigo_Propriedade: TIntegerField
      FieldName = 'Codigo_Propriedade'
    end
    object qryEntradaCodigo_Usuario: TIntegerField
      FieldName = 'Codigo_Usuario'
    end
    object qryEntradaN_Nota_Fiscal: TStringField
      FieldName = 'N_Nota_Fiscal'
    end
    object qryEntradaData_Emissao: TDateTimeField
      FieldName = 'Data_Emissao'
    end
    object qryEntradaCodigo_Fornecedor: TIntegerField
      FieldName = 'Codigo_Fornecedor'
    end
    object qryEntradaCodigo_Comprador: TIntegerField
      FieldName = 'Codigo_Comprador'
    end
    object qryEntradaCodigo_Forma_Pagamento: TIntegerField
      FieldName = 'Codigo_Forma_Pagamento'
    end
    object qryEntradaCodigo_Plano_Financeiro: TIntegerField
      FieldName = 'Codigo_Plano_Financeiro'
    end
    object qryEntradaCodigo_Safra: TIntegerField
      FieldName = 'Codigo_Safra'
    end
    object qryEntradaCodigo_Tipo_Documento: TIntegerField
      FieldName = 'Codigo_Tipo_Documento'
    end
    object qryEntradaCodigo_Departamento: TIntegerField
      FieldName = 'Codigo_Departamento'
    end
    object qryEntradaValor_Produtos: TFloatField
      FieldName = 'Valor_Produtos'
    end
    object qryEntradaValor_Frete: TFloatField
      FieldName = 'Valor_Frete'
    end
    object qryEntradaValor_Seguro: TFloatField
      FieldName = 'Valor_Seguro'
    end
    object qryEntradaValor_Outras_Despesas: TFloatField
      FieldName = 'Valor_Outras_Despesas'
    end
    object qryEntradaValor_Desconto: TFloatField
      FieldName = 'Valor_Desconto'
    end
    object qryEntradaValor_Total_NF: TFloatField
      FieldName = 'Valor_Total_NF'
    end
    object qryEntradaCodigo_Lancamento_Financeiro: TIntegerField
      FieldName = 'Codigo_Lancamento_Financeiro'
    end
    object qryEntradaObservacoes: TStringField
      FieldName = 'Observacoes'
      Size = 800
    end
    object qryEntradaFornecedor: TStringField
      FieldName = 'Fornecedor'
      Size = 100
    end
    object qryEntradaComprador: TStringField
      FieldName = 'Comprador'
      Size = 100
    end
    object qryEntradaCondPag: TStringField
      FieldName = 'CondPag'
      Size = 50
    end
    object qryEntradaPlanoFinanceiro: TStringField
      FieldName = 'PlanoFinanceiro'
      Size = 300
    end
    object qryEntradaSafra: TStringField
      FieldName = 'Safra'
      Size = 50
    end
    object qryEntradaTipoDocumento: TStringField
      FieldName = 'TipoDocumento'
      Size = 50
    end
    object qryEntradaDepartamento: TStringField
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 43024.453012187500000000
  ...
  object qryEntradaProdutos: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select EPP.*, CP.Descricao as Produto from Entrada_Produto_Produ' +
        'tos EPP'
      
        'left join Cadastro_Produtos CP on (EPP.Codigo_Produto = CP.Codig' +
        'o)')
    Left = 768
    Top = 152
    object qryEntradaProdutosCodigo: TAutoIncField
      FieldName = 'Codigo'
      ReadOnly = True
    end
  ...
  object cxPropertiesStore1: TcxPropertiesStore
    Components = <
      ...
      item
        Component = cxGrid1DBTableView14Produto
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView14Quantidade
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView14Unidade
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView14Valor_Compra
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView14Valor_Total
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Comprador
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Data_Emissao
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Fornecedor
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5N_Nota_Fiscal
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Valor_Desconto
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Valor_Frete
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Valor_Outras_Despesas
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Valor_Produtos
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Valor_Seguro
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableView5Valor_Total_NF
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
