...
procedure TSafraEntidade.SetCodigo(const Value: integer);
begin
  FCodigo := Value;
end;

procedure TSafraEntidade.SetCodigo_Propriedade(const Value: integer);
begin
  FCodigo_Propriedade := Value;
end;

procedure TSafraEntidade.SetCodigo_Usuario(const Value: integer);
begin
  FCodigo_Usuario := Value;
end;

procedure TSafraEntidade.SetDataCadastro(const Value: TDate);
begin
  FDataCadastro := Value;
end;

procedure TSafraEntidade.SetDescricao(const Value: AnsiString);
begin
  FDescricao := Value;
end;
