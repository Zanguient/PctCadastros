object FrmRel_Contrato: TFrmRel_Contrato
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Consulta de Contratos de Gr'#227'os'
  ClientHeight = 432
  ClientWidth = 849
  Color = clWindow
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableViewEstoque: TcxGridDBTableView
      ...
      object cxGrid1DBTableViewEstoqueN_Contrato: TcxGridDBColumn
      ...
      object cxGrid1DBTableViewEstoqueContratante: TcxGridDBColumn
      ...
      object cxGrid1DBTableViewEstoqueData_Assinatura: TcxGridDBColumn
        Caption = 'Assinatura'
      ...
      object cxGrid1DBTableViewEstoqueData_Vencimento: TcxGridDBColumn
        Caption = 'Vencimento'
      ...
      object cxGrid1DBTableViewEstoqueArea: TcxGridDBColumn
        Caption = #193'rea'
        DataBinding.FieldName = 'Area'
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Alignment.Horz = taCenter
      ...
      object cxGrid1DBTableViewEstoquePreco: TcxGridDBColumn
        Caption = 'Pre'#231'o'
      ...
      object cxGrid1DBTableViewEstoqueVigencia: TcxGridDBColumn
        Caption = 'Vig'#234'ncia (a)'
  ...
  object qryContrato: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select Con.*, CS.Descricao as Safra, CP.Descricao as Produto, CP' +
        'es.Nome as Contratante'
      'from Contrato Con'
      'left join Cadastro_Safra CS on (Con.Codigo_Safra = CS.Codigo)'
      
        'left join Cadastro_Produtos CP on (Con.Codigo_Produto = CP.Codig' +
        'o)'
      
        'left join Cadastro_Pessoa CPes on (Con.Codigo_Contratante = CPes' +
        '.Codigo)')
    Left = 592
    Top = 8
    ...
    object qryContratoCodigo_Propriedade: TIntegerField
  ...
  object cxPropertiesStore1: TcxPropertiesStore
    Components = <
      item
        Component = cxGrid1DBTableViewEstoqueArea
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableViewEstoqueContratante
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableViewEstoqueData_Assinatura
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableViewEstoqueData_Vencimento
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableViewEstoqueN_Contrato
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableViewEstoquePreco
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
      ...
      item
        Component = cxGrid1DBTableViewEstoqueVigencia
        Properties.Strings = (
          'SortOrder'
          'Visible'
          'Width')
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 43024.452475416660000000
